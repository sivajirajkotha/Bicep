...
// Modules
module vnet '7_1-bicepVirtualNetwork.bicep' = {
  name: vNetInfo.name
  params: {
...
module nsg '7_2-bicepNetworkSecurityGroup.bicep' = {
  name: '${vmName}nsg'
  params: {
    nsgPrefix: vmName
    nsgProperties: [
...
module pip '7_3-bicepPublicIp.bicep' = {
  name: '${vmName}pip'
  params: {
    vmName: vmName
  }
...
module nic '7_4-bicepNetworkInterfaces.bicep' = {
  name: '${vmName}nic'
  params: {
